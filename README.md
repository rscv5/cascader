...
```json
   [ {   children:[
        {label:"prefix",value:"'{}_'.format(date_string())",value_type:"NoneType"},
        ...
        value:"ModelConfig"},
    {   children:[
        {label:"val_decimals",value:"6",value_type:"int"},
        ...
        value:"TrainConfig"},
    {   children:[
        {label:"gather_summ_name",value:"th.prefix+summ_name+th.suffix+'.sum'",value_type:"str"},
    ...
    {children:[
        {label:"job_dir",value:"'/{:02d}_{}'.format(id,model_name)",value_type:"str"},
